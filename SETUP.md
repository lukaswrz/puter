...
```bash
nix run git+https://hack.moontide.ink/helvetica/zap.git /path/to/disk
...
nixos-install --no-root-password --flake git+https://hack.moontide.ink/helvetica/puter.git#hostname
```
