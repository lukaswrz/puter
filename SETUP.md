...
```bash
nix run git+https://hack.moontide.ink/lukas/zap.git /path/to/disk
...
nixos-install --no-root-password --flake git+https://hack.moontide.ink/lukas/puter.git#hostname
```
